...
namespace Core\Plates;

use Core\Plates\Extension\ExtensionInterface;
use Core\Plates\Template\Data;
use Core\Plates\Template\Directory;
use Core\Plates\Template\FileExtension;
use Core\Plates\Template\Folders;
use Core\Plates\Template\Func;
use Core\Plates\Template\Functions;
use Core\Plates\Template\Name;
use Core\Plates\Template\Template;
